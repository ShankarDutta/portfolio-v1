	...
	(
		...
		return (
			<button
				...
				className={cn(
					"group relative z-0 flex cursor-pointer items-center justify-center overflow-hidden [border-radius:var(--radius)] border border-white/10 px-4 py-1 text-[12px] whitespace-nowrap text-white [background:var(--bg)]",
